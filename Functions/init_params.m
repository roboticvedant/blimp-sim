function param = init_params()
    ...
    param.aero.C0M1 = 0.0008;
    param.aero.C0M2 = 0.0008;
    param.aero.C0M3 = 0.0008;

    param.aero.CalphaD = 4.419;
    param.aero.CalphaS = -0.074;
    param.aero.CalphaL = 2.938;
    
    param.aero.CalphaM1 = -0.0008;
    param.aero.CalphaM2 = 0.0008;
    param.aero.CalphaM3 = -0.0008;

    param.aero.CbetaD = 7.508;
    param.aero.CbetaS = -2.113;
    param.aero.CbetaL = 4.554;
    
    param.aero.CbetaM1 = -0.013;
    param.aero.CbetaM2 = 0.013;
    param.aero.CbetaM3 = -0.013;
